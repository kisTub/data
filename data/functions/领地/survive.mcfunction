...
#列举所有区块大小
execute @s ~ ~ ~ funcion 领地:MCA

#成功则变生存
execute @s[x=-3072,y=0,z=-512,dx=2560,dz=1536,dy=255] ~ ~ ~ gamemode 0
execute @s[x=1024,y=0,z=-512,dx=2560,dz=1536,dy=255] ~ ~ ~ gamemode 0
execute @s[x=-512,y=0,z=512,dx=1536,dz=2560,dy=255] ~ ~ ~ gamemode 0
title @s[m=0] title [{"text":"§a生存模式成功"}]
title @s[m=0] subtitle [{"text":"§c公共区域一星期清理一次"}]
execute @s[score_guestqq_min=0,score_guestqq=0] ~ ~ ~ funcion 领地:uid
...
execute @s[score_guestqq_min=1] ~ ~ ~ title @s subtitle [{"text":"§a请去主城重新设置自己的通行证"}]
execute @s[score_guestqq=-1] ~ ~ ~ title @s title [{"text":"§c领地密码错误"}]
execute @s[score_guestqq=-1] ~ ~ ~ title @s subtitle [{"text":"§a请去主城重新设置自己的通行证"}]
