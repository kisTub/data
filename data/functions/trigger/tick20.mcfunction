...
execute @s[score_home.set_min=1] ~ ~ ~ function trigger:home/set
execute @s[score_home.back_min=1] ~ ~ ~ function trigger:home/back
execute @s[score_home.remove_min=1] ~ ~ ~ function trigger:home/remove
execute @s[score_home.list_min=1] ~ ~ ~ function trigger:home/list
