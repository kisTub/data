#空闲状态
scoreboard players test #tpa_mode var 0 0 
#--> if_sender
scoreboard players test #tpa_mode var -1 -1
#--> reset
scoreboard players test #tpa_mode var 1 1
#--> read_spawn_dynamic_uid
scoreboard players test #tpa_mode var 2 2
#--> spawn_dynamic_uid
scoreboard players test #tpa_mode var 3 3
#--> seek_receiver
setblock -490 18 539 minecraft:redstone_block
scoreboard players test #tpa_mode var 4 4
setblock -491 18 539 minecraft:redstone_block
#--> receiver_true
scoreboard players test #tpa_mode var 5 5
setblock -492 18 539 minecraft:redstone_block
#--> receiver_false
scoreboard players test #tpa_mode var 6 6
setblock -493 18 539 minecraft:redstone_block
#receiver_decision
scoreboard players test #tpa_mode var 7 7 
setblock -494 18 539 minecraft:redstone_block
#agree
scoreboard players test #tpa_mode var 8 8 
setblock -495 18 539 minecraft:redstone_block
#disagree

#9
setblock -496 18 539 minecraft:redstone_block

scoreboard players test #tpa_mode var 2 *
#--> time_cut_down
setblock -497 18 539 minecraft:redstone_block
