...
#初始称号
execute @a[score_ch_min=100,score_ch=100] ~ ~ ~ function ch:i
#更换其他称号
execute @a[score_ch_min=1,score_ch=99] ~ ~ ~ function ch:iexc
#打开称号仓库
execute @a[score_ch_min=-1,score_ch=-1] ~ ~ ~ function ch:depot
#药水效果
