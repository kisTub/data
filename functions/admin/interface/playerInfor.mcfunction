...
tellraw @s ["",{"text":"  界面设置："}]
tellraw @s[tag=!-clearWarning] ["",{"text":"  显示清理警告 "},{"text":"开","color":"green"}]
tellraw @s[tag=-clearWarning] ["",{"text":"  显示清理警告 "},{"text":"关","color":"red"}]
tellraw @s[tag=!-appActionbar] ["",{"text":"  主城活动栏显示 "},{"text":"开","color":"green"}]
tellraw @s[tag=-appActionbar] ["",{"text":"  主城活动栏显示 "},{"text":"关","color":"red"}]
