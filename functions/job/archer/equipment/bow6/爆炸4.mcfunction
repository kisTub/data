...
give @s[tag=ench:爆炸] minecraft:bow 1 0 {ice:1b,boom:1b,lighting:1b,archer:1b,bow:6,display:{Name:"§0Lv6 §f光之弓",Lore:["§7爆炸","§7冰霜","§7雷电","§6〓〓〓〓〓〓〓〓","§b至强的力量","§c神话级装备"]},ench:[{id:48s,lvl:10s},{id:50s,lvl:6s},{id:49s,lvl:5s},{id:70s,lvl:1s}]}
