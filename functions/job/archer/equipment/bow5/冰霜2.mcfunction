...
give @s[tag=ench:冰霜] minecraft:bow 1 0 {ice:1b,lighting:1b,archer:1b,bow:5,display:{Name:"§6Lv5 §c轩辕弓",Lore:["§7冰霜","§7雷电","§6〓〓〓〓〓〓〓〓","§a神匠打造给轩辕帝的弓","§c可升级，自身附魔、命名不继承"]},ench:[{id:48s,lvl:8s},{id:50s,lvl:5s},{id:49s,lvl:5s},{id:70s,lvl:1s}]}
