...
execute @s[tag=enter_sever,score_enter_sever_min=20,score_enter_sever=20] ~ ~ ~ function login:first/if_same_name/false

#重复名称后删除进入游戏的进度判据，并高频kill
advancement revoke @s[tag=!enter_sever,score_enter_sever_min=20] only _ADM:player_first_login
