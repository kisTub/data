...
tellraw @s ["",{"text":"  花粉 "},{"score":{"objective":"花粉","name":"@s"},"color":"green"},{"text":" 蓝晶 ","color":""},{"score":{"objective":"蓝晶","name":"@s"},"color":"green"},{"text":" 击杀实体数 "},{"score":{"objective":"击杀","name":"@s"},"color":"green"},{"text":" 维度旅行次数 "},{"score":{"objective":"dimenTravel","name":"@s"},"color":"green"}]
