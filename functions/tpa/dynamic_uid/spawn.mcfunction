scoreboard players tag @e[tag=主城,c=1] remove spawn_dynamic_uid
...
scoreboard players operation @e[tag=主城,c=1] tpa_temp = #check_count var
function tpa:open_player_list if @e[tag=主城,c=1,score_tpa_temp=0]
function tpa:dynamic_uid/spawn if @e[tag=主城,c=1,score_tpa_temp_min=1]
