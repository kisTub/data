scoreboard players set #lv_up_cost var 500
...
function item:egg/mine_ore/8 if @s[score_temp_min=0]
clear @s[score_temp_min=0] spawn_egg 0 1 {id:"summon_egg",EntityTag:{Tags:["lv7"]}}
