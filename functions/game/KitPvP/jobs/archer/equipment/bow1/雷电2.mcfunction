...
give @s[tag=ench:雷电] minecraft:bow 1 0 {ice:1b,lighting:1b,bow:1,archer:1b,display:{Name:"§fLv1 §a猎人弓",Lore:["§7冰霜","§7雷电","§6〓〓〓〓〓〓〓〓","§a打猎老人专用","§c可升级，自身附魔、命名不继承"]},ench:[{id:48s,lvl:3s},{id:50s,lvl:1s},{id:49s,lvl:2s},{id:70s,lvl:1s}]}
