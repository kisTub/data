...
give @s[tag=ench:爆炸] minecraft:bow 1 0 {boom:1b,bow:1,archer:1b,bow:4,display:{Name:"§cLv4 §6落日弓",Lore:["§7爆炸","§6〓〓〓〓〓〓〓〓","§6蕴含太阳金辉","§c可升级，自身附魔、命名不继承"]},ench:[{id:48s,lvl:7s},{id:50s,lvl:4s},{id:49s,lvl:5s},{id:70s,lvl:1s}]}
