...
give @s[tag=ench:冰霜] minecraft:bow 1 0 {ice:1b,boom:1b,lighting:1b,archer:1b,bow:2,display:{Name:"§bLv2 §3训练制式弓",Lore:["§7爆炸","§7冰霜","§7雷电","§6〓〓〓〓〓〓〓〓","§a新人训练专用","§c可升级，自身附魔、命名不继承"]},ench:[{id:48s,lvl:4s},{id:50s,lvl:3s},{id:49s,lvl:3s},{id:70s,lvl:1s}]}
