...
#
give @s[tag=sword:4→5] minecraft:diamond_sword 1 0 {ench:[{id:16s,lvl:7s},{id:17s,lvl:7s},{id:18s,lvl:7s},{id:34s,lvl:7s},{id:21s,lvl:5s},{id:22s,lvl:5s},{id:19s,lvl:3s}],display:{Name:"§6Lv5 §b蓝蔷薇之剑",Lore:["§6〓〓〓〓〓〓〓〓","§3以寒冰将对手冻结！","§c可升级，自身附魔、命名不继承"]},sword:5,soldier:1b}
#
playsound minecraft:block.anvil.use ambient @s[tag=sword:4→5]
tellraw @s[tag=sword:4→5] [{"text":"§6【Soldier】  §a新装备打造成功!"}]
tellraw @a[tag=!sword:4→5] [{"text":"§6【Soldier】  §a祝贺},{"selector":"@a[tag=sword:4→5]","color":"gold"},{"text":"§6 Lv5蓝蔷薇之剑装备 打造成功!"}]
...
#条件重置
scoreboard players reset @s equipment:sword
