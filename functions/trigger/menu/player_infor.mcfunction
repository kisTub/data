...
tellraw @s ["",{"text":"  花粉 "},{"score":{"objective":"money","name":"@s"},"color":"green"},{"text":" 蓝晶 ","color":""},{"score":{"objective":"bs","name":"@s"},"color":"green"},{"text":" 击杀实体数 "},{"score":{"objective":"killed_entity","name":"@s"},"color":"green"}]
